...
function TextInput({ type = "text", label }) {
  ...
  return (
    <div className={`${Styles.inputContainer} mb-4`}>
      ...
      />
      <label
        className={`${value && Styles.filled} d-flex align-items-center gap-2`}
        htmlFor={name}
      >
        {label}
      </label>
...
export default function ContactSection() {
  return (
    <section className="container p-5 my-5" id="contacto">
      <h1
        className="m-0 text-center mx-auto mb-5 text-break"
        style={{
          fontWeight: "600",
          backgroundImage:
      ...
      <div className="d-flex justify-content-center mb-4 mx-auto">
        ...
        >
          <input
            type="hidden"
            name="apikey"
            value="440a9ba4-d3bb-4677-b684-96b2a828af86"
          />
          <input
            type="hidden"
            name="subject"
          ...
          <div>
            <TextInput
              label={[
                ...
                <TiUserOutline
                  className="fs-5"
                  style={{ color: "rgb(227,46,51, .7)", width: "15px" }}
                />,
              ]}
            />
          </div>
          ...
          <div>
            <button
              button
              className="w-100 btn btn-block btn-lg text-light btn-danger"
              type="submit"
              value="Submit"
              style={{ backgroundImage:
                "linear-gradient(225deg, hsla(0, 100%, 50%, 1) 0%, hsla(0, 100%, 64%, 1) 100%)", fontWeight: "500" }}
            >
              Enviar
            </button>
          </div>
